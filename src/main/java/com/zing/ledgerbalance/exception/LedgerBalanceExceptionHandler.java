...
import com.zing.ledgerbalance.model.ExceptionStatus;
...
public class LedgerBalanceExceptionHandler {
    ...
    Logger logger = LoggerFactory.getLogger(LedgerBalanceExceptionHandler.class);
    ...
    @ExceptionHandler(value = {LedgerBalanceNotFoundException.class})
